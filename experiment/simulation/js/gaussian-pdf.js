...
//     const xRange = linspace(-3, 3, 100);
//     const yRange = linspace(-3, 3, 100);
//     const z = [];
...
//     const layout2D = {
//         title: 'Contour Plot of Gaussian PDF',
//         xaxis: {title: 'x', range: [-3, 3]},
//         yaxis: {title: 'y', range: [-3, 3]},
//         width: 500,
//         height: 500,
...
//     update2DPlot(); // Update the plots with reset values
// }

// function setupEventListeners() {
//     document.getElementById('resetButton').addEventListener('click', resetInputs);
//     document.getElementById('updateButton').addEventListener('click', update2DPlot);
